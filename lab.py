...
numbers = [2, 4, 5, 7, 7, 10, 13]
odd_count = 0

for num in numbers:
    # Breakpoint idea: pause here and inspect the value of num.
    # Print idea: print(f"Before check: num={num}, odd_count={odd_count}")
    if num % 2 == 1:
        odd_count += 1

print("Odd numbers found:", odd_count)
# Tinker ideas:
# - Change one number in the list to an odd number.
# - Change the condition from % 2 == 0 to % 2 == 1.
# - Change the starting value of odd_count.
